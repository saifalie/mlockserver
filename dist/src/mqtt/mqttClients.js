...
export class RelayMQTTClient extends EventEmitter {
    constructor(options = {}) {
        ...
        // MQTT configuration
        this.BROKER_URL = process.env.MQTT_BROKER_URL;
        this.PORT = parseInt(process.env.MQTT_PORT || '8883');
        this.USERNAME = process.env.MQTT_USERNAME;
        this.PASSWORD = process.env.MQTT_PASSWORD;
        this.CLIENT_ID = "nodejs-server";
        this.TOPICS = {
    ...
    async sendCommand(command, topic) {
        return new Promise((resolve, reject) => {
            if (!this.isConnected || !this.client) {
                return reject(new InternalException('Not connected to MQTT broker', ErrorCode.INTERNAL_EXCEPTION, { message: 'Not connected to MQTT broker' }));
            }
...
//   }
// };
//# sourceMappingURL=mqttClients.js.map